...
/****** Object:  Database [yogeshdb]    Script Date: 16/06/2021 12:30:15 PM ******/
CREATE DATABASE [yogeshdb]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'yogeshdb', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\yogeshdb.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'yogeshdb_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL14.SQLEXPRESS\MSSQL\DATA\yogeshdb_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO
...
/****** Object:  Table [dbo].[Movies]    Script Date: 16/06/2021 12:30:15 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Customer]    Script Date: 16/06/2021 12:30:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[RentedMovies]    Script Date: 16/06/2021 12:30:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[MovieConnection]    Script Date: 16/06/2021 12:30:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[CustomerMoviesRentals]    Script Date: 16/06/2021 12:30:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
FROM            dbo.RentedMovies INNER JOIN
                         ...
                         dbo.Customer ON dbo.RentedMovies.CustIDFK = dbo.Customer.CustID
GO
/****** Object:  View [dbo].[MovieView]    Script Date: 16/06/2021 12:30:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
FROM            dbo.Movies
GO
/****** Object:  View [dbo].[MoviesOut]    Script Date: 16/06/2021 12:30:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[TopCustomers]    Script Date: 16/06/2021 12:30:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [dbo].[TopMovies]    Script Date: 16/06/2021 12:30:15 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
